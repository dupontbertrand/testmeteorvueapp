<template>
  <div class="container py-2 py-md-5">
    ...
    <div id="step_1" v-if="step == 1">
      <div class="row">
        <div class="form_custom shadow-sm">
      ...
      <div class="row">
        <div class="col-6 offset-6 offset-md-0 col-md-12 mt-2 d-flex justify-content-end">
    ...
    <div id="step_2" v-if="step == 2">
      <div class="row">
        <div class="form_custom shadow-sm px-3">
          <div class="col-12 text-center">
            <p><img src="img/" alt="">Quel est votre statut ?</p>
          </div>
          <div class="col-12 d-block d-md-flex justify-content-md-around text-center">
            <div class="mb-3 mb-md-0">
              ...
              <label class="form-check-label button w-100" for="radioStatusEtudiant"><img src="img/boy.png">Étudiant</label>
            </div>
            <div class="mb-3 mb-md-0">
              ...
              <label class="form-check-label button w-100" for="radioStatusDemandeur"><img src="img/job-search.png">Demandeur d'emploi</label>
            </div>
            <div class="mb-3 mb-md-0">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="radioStatusSalarié" value="salarié" v-model="form.status">
              <label class="form-check-label button w-100" for="radioStatusSalarié"><img src="img/salary.png">Salarié (Secteur privé)</label>
            </div>
            <div class="mb-3 mb-md-0">
              ...
              <label class="form-check-label button w-100" for="radioStatusFonctionnaire"><img src="img/team.png">Fonctionnaire</label>
            </div>
            <div class="mb-3 mb-md-0">
              ...
              <label class="form-check-label button w-100" for="radioStatusIndépendant"><img src="img/idea.png">Indépendant</label>
            </div>
            <div class="mb-3 mb-md-0">
              ...
              <label class="form-check-label button w-100" for="radioStatusRetraité"><img src="img/retirement.png">Retraité</label>
            </div>
          </div>
        </div>
        ...
        <div v-if="conditionKm(form.status)" class="form_custom shadow-sm mt-4">
          ...
          <div class="col-12 text-center">
            <div class="form-check form-check-inline">
              ...
              <label class="form-check-label button transport" for="radioChargeYes"><img src="img/yes.png">Oui</label>
            </div>
            <div class="form-check form-check-inline mt-3 mt-md-0">
              <input class="form-check-input" type="radio" name="inlineRadioOptions" id="radioChargeNo" value="Non" v-model="form.transportToWork">
              <label class="form-check-label button transport" for="radioChargeNo"><img src="img/no.png">Non</label>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-6 col-md-6 mt-2 d-flex justify-content-end">
    ...
    <div id="step_3" v-if="step == 3">
      <div class="row" v-if="aidesAvailable == false">
        <div>
          <p class="text-center text-no-aides">Aucune aide n'est disponible pour votre profil, merci de vérifier les informations saisies.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-12 form_custom text-center p-3">
      ...
      <div class="row">
        <div v-for="aide in aidesPossibles" class="col-12 col-md-4 mt-3">
    ...
    getAides(event) {
      ...
      Meteor.call('getAides', this.form, (error, results) => {
        ...
        if (error) {
          ...
          this.loader = false;
          if (results.length == 0) this.aidesAvailable = false;
...
<style scoped>
  ...
  #step_1 .button, #step_2 .transport {
